"""
SCRAPER MODULE - Web Scraping with Threading
Kişi 1: Web Scraping ve Threading sorumlusu
Bu modül farklı haber kaynaklarından paralel olarak veri toplar
"""
...
class NewsScraper:
    ...
    def scrape_bbc(self) -> List[NewsArticle]:
    ...
    def scrape_cnn(self) -> List[NewsArticle]:
        """CNN'den haber çek"""
        articles = []
        try:
    ...
    def scrape_aljazeera(self) -> List[NewsArticle]:
    ...
    def scrape_npr(self) -> List[NewsArticle]:
        """NPR'den haber çek"""
        articles = []
        try:
    ...
    def scrape_all(self) -> List[NewsArticle]:
        ...
        Returns:
            List[NewsArticle]: Toplanan tüm haberler (NewsArticle nesneleri)
        """
...
if __name__ == "__main__":
    ...
    for i, article in enumerate(articles[:3], 1):
        ...
        print(f"   Type: {type(article).__name__}")  # "NewsArticle" olmalı